...
import 'package:yatzy/views/init_screen.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      //home: const MyHomePage(title: 'Yatzy Board'),
      initialRoute: InitScreen.ROUTE,
      routes: {
        InitScreen.ROUTE: (context) => const InitScreen(),
        BoardView.ROUTE: (context) => const BoardView()
      },
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    // by the _addPlayer method above.
    //
